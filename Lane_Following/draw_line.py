...
def get_yellow( img, dump=False, filename="" ):
	return get_range( img, np.array([20, 110, 225], np.uint8), np.array([35, 135, 255], np.uint8), cv2.COLOR_BGR2HSV, dump=dump, filename=filename )
...
if __name__ == "__main__":
	...
	line_whites  = get_range( img, np.array([50,150,30], np.uint8), np.array([255,255,130], np.uint8), cv2.COLOR_BGR2HLS, dump=True, filename="result/lined_white.jpg" )
